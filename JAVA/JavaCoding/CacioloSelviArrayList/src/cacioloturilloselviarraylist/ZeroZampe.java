 ...
 */
public class ZeroZampe extends Animale implements Comparable {

    private int compare; // attributo usato per l'ordinamento dell' arrayList<>

    public ZeroZampe(String specie, Data dataNascita) {
    ...
    /**
     * equals specifico della classe ZeroZampe
     *
     * @param z, ZeroZampe
     * @return true se sono uguali, altrimenti false
     */
    public boolean equals(ZeroZampe z) {
        return (!z.isNull() && super.equals(z) && nZampe.compareTo(z.getnZampe()) == 0);
    }

    /**
     * compareTo specifico di ZeroZampe, orndina per primo il numero di zampe e
     * dopo richiama il metodo compareTo della superclasse
     *
     * @param z, Animale a ZeroZampe
     * @return -1 se questo e' piu' piccolo del parametro passato, 1 se e' piu'
     * grande e 0 se sono uguali
     */
    public Integer compareTo(ZeroZampe z) {
        if (this.nZampe.compareTo(z.getnZampe()) < 0) {
            return -1;
        }
        if (this.nZampe.compareTo(z.getnZampe()) > 0) {
            return 1;
    ...
    /**
     * Override del metodo, compareTo specifico della classe ZeroZampe, usato
