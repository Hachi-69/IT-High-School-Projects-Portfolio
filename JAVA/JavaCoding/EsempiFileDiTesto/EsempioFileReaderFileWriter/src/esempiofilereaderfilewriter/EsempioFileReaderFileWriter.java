package esempiofilereaderfilewriter;

import java.io.*;

public class EsempioFileReaderFileWriter {
    /*
     Esempio in cui presentiamo la lettura e scrittura di un file di testo
     */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*
             Le scrivo usando il metodo print. Vedremo poi in lettura che effetto si ottiene.
             */
            pw.print(primaStringaDaScrivereSuFile);
            pw.print(secondaStringaDaScrivereSuFile);
            pw.print(terzaStringaDaScrivereSuFile);
            /*
             flush dello stream
             */
            pw.flush();
