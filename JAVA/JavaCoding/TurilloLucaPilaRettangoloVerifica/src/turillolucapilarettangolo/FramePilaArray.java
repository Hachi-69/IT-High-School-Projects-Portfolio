...
public class FramePilaArray extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlMenu.add(cmbTipo);
        cmbTipo.setBounds(170, 110, 102, 23);
        ...
        btnPiuCostoso.setBounds(230, 170, 140, 24);
        ...
        btnMenoCostoso.setBounds(230, 200, 140, 24);
        ...
        btnMenoVenduto.setBounds(230, 260, 140, 24);
        ...
        btnPiuVenduto.setBounds(230, 230, 140, 24);
        ...
        btnNMedioPezzi.setBounds(230, 290, 140, 24);
        ...
        btnCostoMedio.setBounds(230, 320, 140, 24);
        ...
        btnContaTipo.setBounds(230, 380, 140, 24);
        ...
        cmbTipo1.setBounds(130, 380, 102, 23);
        ...
        btnSopraMedia.setBounds(230, 350, 140, 24);

        getContentPane().add(pnlMenu);
        pnlMenu.setBounds(10, 90, 780, 470);
        getContentPane().add(jSeparator1);
        jSeparator1.setBounds(680, 170, 0, 3);
